...
router.get('/register', function(req, res, next) {
  ...
  const notFirstVisit = cookies.get('email', { signed: true });
    if (notFirstVisit)
        res.render('register', {title: 'Express' , imglogo: '/images/0.png', mailExists:false, email: notFirstVisit});
    else
        res.render('register', {title: 'Express' , imglogo: '/images/0.png', mailExists:false, email: ''});
});
